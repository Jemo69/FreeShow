...
export const freeNoteActive: Writable<boolean> = writable(false)
export const freeNoteNow: Writable<number> = writable(-1)
export const freeNoteSlides: Writable<any[]> = writable([])
export const freeNoteHistory: Writable<any[]> = writable([])
export const freeNoteDrafts: Writable<any[]> = writable([])
export const freeNoteMode: Writable<"markdown" | "rich"> = writable("markdown")
export const freeNoteProjection: Writable<string> = writable("")
